...
describe 'A movie' do
  it 'is a flop if the total gross is less than $50M' do
    movie = Movie.new(total_gross: 400_000_00)

    expect(movie.flop?).to eq(true)
  end

  it 'is not a flop if the total gross is greater than $50M' do
    movie = Movie.new(total_gross: 600_000_00)
  ...
  it 'returns released movies ordered with the most recently movie first' do
  ...
  it 'accepts a positive total gross' do
    movie = Movie.new(total_gross: 100_000_00.00)
